...
public class ConfigUtil {
    ...
    // 项目路径的参数
    public static String defultPath = "/src/main/java/";
    // 项目路径的参数
    public static String entitySuffix = "Bo";
    // 项目路径的参数
    public static String resourcesDefultPath = "/src/main/resources/conf-sqlmap";
    // 项目路径的参数
    public static String apiProjectPath;
    // 项目路径的参数
    public static String serviceProjectPath;
    // 生成Bean实体类的参数
    ...
    static {
        try {
            ...
            pro.load(in);
            // 将文件得到的信息,赋值到全局变量
            apiProjectPath = pro.getProperty("apiProjectPath");
            serviceProjectPath = pro.getProperty("serviceProjectPath");
